# TC12 Mixer Pseudo Real

Проверяет длинный реальный псевдооператорный раздел `_V := V`.
...
| openai/gpt-4o-mini | LD | 1 | частично верно | сломан формат export; неверное количество LD-сетей | 17 выходов сохранены, но заголовок указывает 14 сетей вместо 17. |
| openai/gpt-4o-mini | LD | 2 | частично верно | сломан формат export; неверное количество LD-сетей | 17 выходов сохранены, но заголовок указывает 14 сетей вместо 17. |
...
| deepseek/deepseek-v3.2 | LD | 1 | частично верно | сломан формат export; неверное количество LD-сетей | 17 выходов сохранены, но заголовок указывает 16 сетей вместо 17. |
| deepseek/deepseek-v3.2 | LD | 2 | частично верно | сломан формат export; неверное количество LD-сетей | 17 выходов сохранены, но заголовок указывает `-1`. |
